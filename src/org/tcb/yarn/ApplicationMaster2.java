...
public class ApplicationMaster2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (allocatedContainers < n) {
            ...
            for (Container container : response.getAllocatedContainers()) {
                ...
                appContainer.setCommands(
                        Collections.singletonList(
                                "$JAVA_HOME/bin/java" +
                                        " -Xmx256M" + 
                                        " org.tcb.yarn.Test" + " " +   (allocatedContainers-1)*interval + " " + ((allocatedContainers)*interval ) + " " +
            ...
            for (ContainerStatus status : response.getCompletedContainersStatuses()) {
                ++completedContainers;
                System.out.println("Completed container " + completedContainers + " " + status);
            }
            Thread.sleep(100);
        }
        ...
        while (completedContainers < n) {
            ...
            for (ContainerStatus status : response.getCompletedContainersStatuses()) {
                ++completedContainers;
                System.out.println("Completed container " + completedContainers + " " + status + "n==" + completedContainers );
            }
            Thread.sleep(100);
        }
